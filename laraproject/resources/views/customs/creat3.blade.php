...
<tr><td align="center"class="hei">{{$arr51[2]}}</td></tr>
<tr><td align="center"class="hei">{{$arr51[0]}}</td></tr>
<tr><td align="center"class="hei">{{$arr51[1]}}</td></tr>
</table>
...
<?php
$checkk='';
if(isset($arr51)){   $checkk='OKOK';    }
?>
<script>
var checkk='<?php echo $checkk; ?>';
if(checkk=='OKOK'){
window.location.href = "{{URL::to('customs/signin')}}";
}
</script>
