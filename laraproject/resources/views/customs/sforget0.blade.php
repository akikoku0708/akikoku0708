...
<table class="tb_creat03"align="center"border="0">
  ...
  <form method="POST" id="contactform" action="/customs/sforget1">
    @csrf

  <tr><td align="center"colspan="4" class="td_creat05"><strong>Set a new password</strong></td></tr>

<tr><td class="td_creat05a"></td><td colspan="2">
  <input type="email" name="email" value="{{ old('email') }}" placeholder=" email"style="border-radius:5px;color:#333;border:none;background-color:#fff; height:40px;width:99%"/>
  @error('email')
    <div class="div_creat06">{{ $message }}</div>
  @enderror
...
<a href="{{ url('customs/signin') }}"class="a_creat08" >Login an acount</a>
</td></tr></table>
