...
<tr><td class="td_creat05b"></td><td colspan="2"> </td><td> </td></tr>
  ...
  <form method="POST" id="contactform" action="/members/creat2">
    @csrf
 ...
 <input type="email" name="email" class="in_creat209"value="{{ old('email') }}" placeholder=" email"/>
  ...
  @error('email')
    ...
    <tr><td></td><td colspan="2">
        <input  type="text"name="name"class="in_creat09"value="{{ old('name') }}" placeholder="名前（担当者）" >
        @error('name')
          <div class="div_creat06">{{ $message }}</div>
        @enderror
      </td><td> </td></tr>
      ...
      <tr><td></td><td colspan="2">
          <input  type="text"name="storeja"class="in_creat09"value="{{ old('storeja') }}" placeholder="店名（日本語）" >
          @error('storeja')
            <div class="div_creat06">{{ $message }}</div>
          @enderror
        </td><td> </td></tr>
        <tr><td></td><td colspan="2">
            <input  type="text"name="storeen"class="in_creat09"value="{{ old('storeen') }}" placeholder="店名（ローマ字）" >
            @error('storeen')
              <div class="div_creat06">{{ $message }}</div>
            @enderror
          </td><td> </td></tr>
...
<tr><td align="center">
<a href="{{ url('members/creat0') }}" class="a_creat08"><h3> Back to creat </h3></a>
</td></tr></table>
