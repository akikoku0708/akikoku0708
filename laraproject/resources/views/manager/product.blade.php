...
<style>
#wreview {     width: 98%px;   overflow-y: scroll;
...
<div id="wreview"style="height:20px;">
...
<!-- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<dialog id="favDialog"style="width:70%">
  <table width="100%"align="center"border="0">
  <tr><td width="95%"></td><td onclick="dialog2();"class="ft24"width="5%">×</td> </tr>
  <tr class="he30"><td colspan="2"style="vertical-align:top"><div align="center"id="dialog"></div></td> </tr>
  </table>
</dialog>
...
//--------------------------------------------------------------
 ...
 $('.thumbnails img').click(function(){
  ...
  var formData= new FormData();     var ikey=0; var iddia='';
  //---------------------------------------------------------------------
...
//------------------------------------------------------
 ...
 function funcdele(ele){  ikey=188;
  ...
  var favDialog = document.getElementById('favDialog');
  	function dialog(dia){ iddia=dia.id;
    if (typeof favDialog.showModal === "function") { ikey=588;
      favDialog.showModal();
    ...
    //-----------------------------------------------------------
function diaimg(eled){  $('.imaget').children('img').attr('src', '../storage/img_review/'+eled.id+''); }
...
var arrimg=[]; var btndele=''; arrimg6=[]; var imdia6='';  imdia6a=''; imdia6b='';
...
//---------------------------------------------------------
if(data.iddia==reviewdb[t]['evalutecode']){
 imdia6=reviewdb[t]['picreview'];  arrimg6=imdia6.split('|');


     if(arrimg6.length>0){
         for(var j6=0;j6<arrimg6.length;j6++){
         imdia6b='<span id="'+arrimg6[j6]+'"onclick="diaimg(this);">'+'<img src="../storage/img_review/'+arrimg6[j6]+'"onclick="diaimg();" class="imgcss19"></span>';
         imdia6a=imdia6a+imdia6b;
  }  }


imbdp5='<table class="ft11"border="0"width="100%">'
...
+'<div align="center"class="imaget"><img src="../storage/img_review/'+arrimg6[0]+'" class="imgcss22"></span></div>'
+'<hr style="width:100%;border:none;margin-top: 0.1em; margin-bottom: 0.3em;">'
+'<div align="center">'+imdia6a+'</div>'
+'<hr style="width:100%;border:none;margin-top: 0.1em; margin-bottom: 0.3em;">'
...
if(custcode==reviewdb[t]['loginid']){
 ...
 imbdp2=reviewdb[t]['picreview'];  arrimg=imbdp2.split('|');
  var numimg=0;
  if(imbdp2!=''){imbdp1='';
      if(arrimg.length>0){ numimg=arrimg.length;
          for(var j2=0;j2<3;j2++){    //arrimg.length;

          imbdp1b='<span >'+'<img src="../storage/img_review/'+arrimg[j2]+'" id="'+arrimg[j2]+'"class="imgcss19"></span>';
          if(j2<=numimg-1){  imbdp1=imbdp1+imbdp1b;            }
...
+'<hr style="width:100%;border:none;margin-top: 0.1em; margin-bottom: 0.3em;">'
+'<p align="left">'+reviewdb[t]['review'].slice( 0, 40 )+' '
+'・・・<button id="'+reviewdb[t]['evalutecode']+'"onclick="dialog(this);"class="btncss22">詳細</button></p>'
+'<div align="left">'+imbdp1+'<span style="position:relative;top:-20px;margin-left:20px;">画像:'+numimg+'枚</span>'+'</div>'
+'<hr style="width:100%;border:none;margin-top: 0.1em; margin-bottom: 0.3em;">'
//+'<div align="right" id="'+reviewdb[t]['evalutecode']+'"onclick="dialog(this);"><button class="btncss22">画像拡大</button></div>'
+'<hr style="width:100%;border:none;margin-top: 0.1em; margin-bottom: 0.3em;">'
+'</td></tr></table>';
...
if(mainre!=''){ $('#wreview').css('height','400px');    }

$('#display').html(mainre);

//---------------------------------------------------------------------------
if(data.ikey==588){    // alert(data.ikey);
//------------------------------------
$('#dialog').html('<div class="fade-img">'+imbdp5+'</div>');
//-----------------------------------------
}
if(data.ikey==88){
